...
{
local marqueeBkg = fe.add_image("black.png", blip*0.076, blip*0.0038, blip*0.495, blip*0.305 );
...
local marquee = FadeArt("marquee", blip*0.07, blip*0.043, blip*0.495, blip*0.32 );
